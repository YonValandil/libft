...
CFILES =	ft_putchar ft_putchar_fd ft_putstr ft_putstr_fd						\
			...
			ft_strlen ft_arrlen ft_strcmp ft_strncmp ft_strcat ft_strncat ft_strlcat ft_strtrim ft_strjoin ft_strappend ft_strsub																			\
			ft_bzero ft_memalloc ft_realloc ft_memdel ft_memset ft_memmove ft_memcpy ft_memccpy ft_memcmp ft_memchr ft_strstr ft_strnstr														\
			...
			ft_swap ft_range ft_sqrt ft_pow ft_abs\
			ft_lstnew ft_lstdelone ft_lstdel ft_lstadd ft_lstadd_end ft_lstiter ft_lstmap
