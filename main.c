...
/*static void		ptrfnct(unsigned int n,char *s)
{
	printf("\nptrfnct avant = %c\n", s[n]);
	s[n] = s[n] + 1;
...
static char		ptrfnctchar(unsigned int i, char c)
{
	printf("\nptrfnct avant = %c\n", c);
	printf("\ni =  = %d\n", i);
	c = c + 1;
...
int			main(void)
{
	...
	//char e[] = "panda";
	//char d[] = " un panda qui mange  une banane";
	//char *strcat;
	//char *strjoin;
	//char *mem;
	//int c;
	...
	*i = 12345;
	...
	r = ft_strlcat(dest, str, 11);
	printf("\nstrlcat = %zu", r);*/
	//r = strlcat(dest, str, 11);
	//printf("\nstrlcat dest = %zu", r);
